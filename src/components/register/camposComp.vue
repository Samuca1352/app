    ...
    <div class="form">
      <v-container class="grey lighten-5">
        <v-row no-gutters>
          <v-row class="pa-1" >
            <v-row class="pa-2">
              <img
                src="http://congressointereduca.web249.uni5.net/certificados/img/tsuru-origami.png"
              />
              <div class="space">
                <h1>Sistema</h1>
              </div>
      ...
      <div>
        <div class="text-register">
          Ao se cadastra, você concorda com nossos
          <b>Termos, Politicas de Privacidade e Politica de Cookies</b>
        </div>
      </div>
      <v-btn class="btn-register" @click="register">Cadastre-se</v-btn>
    </div>
  </div>
</template>
<script setup>
